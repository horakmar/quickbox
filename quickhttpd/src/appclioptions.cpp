	...
	: Super(parent)
{
	...
	addOption("application.profile").setType(QVariant::String).setNames("--profile").setDefaultValue("both").setComment("Rendering profile to use (results|startlists|both)");
